...
class PeminjamanRepository(private val peminjamanService: PeminjamanService) {
    ...
    suspend fun updateStatusPeminjaman(token: String, peminjamanId: Long, peminjamanStatusRequest: PeminjamanStatusRequest): PeminjamanResponse = peminjamanService.updateStatusPeminjaman("Bearer $token", peminjamanId, peminjamanStatusRequest)
}
